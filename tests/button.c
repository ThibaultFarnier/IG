...
int ei_main(int argc, char** argv)
{
	...
	char*		button_title		= "Owi, clique moi d'sus - J'aime ça, petit cochon.";
	...
	ei_button_configure	(button, &button_size, &button_color,
				&button_border_width, &button_corner_radius, &button_relief, &button_title/*NULL*/, NULL, NULL, NULL,
				/*&img*/NULL, NULL, NULL, &button_callback, NULL);
